...
import com.cjh.blockbuster.api.model.enums.user.LoginTypeEnum;
import com.cjh.blockbuster.api.model.enums.user.StarSourceEnum;
...
import com.cjh.blockbuster.core.util.TransactionUtil;
import com.cjh.blockbuster.service.user.converter.UserAiConverter;
...
import com.cjh.blockbuster.service.user.service.RegisterService;
import com.cjh.blockbuster.service.user.service.help.UserPwdEncoder;
    ...
    public void bindOldUser(String userName, String password, String starNumber, String invitationCode, Long userId) {
        ...
        if (userAiDO == null) {
            ...
            if (!Objects.equals(starNumber, userAiDO.getStarNumber())) {
                ...
                // 改变登录用户的星球状态
                ReqInfoContext.getReqInfo().getUser().setStarStatus(UserAIStatEnum.fromCode(UserAIStatEnum.TRYING.getCode()));
            }
        }
